        ...
        <header className={classes.webHeader}>
            ...
            <nav ref={wrapperRef} className={classes.navbar}>
                ...
                >
                    ...
                    <svg className={classes.logo} style={{margin: window.innerWidth > 600 ? '0 50px': 'auto 10px'}}  width={window.innerWidth > 600 ? "200" : "150"}  viewBox="0 0 200 56" fill="none" xmlns="http://www.w3.org/2000/svg">
