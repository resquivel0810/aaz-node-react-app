        ...
        <header className={classes.webHeader}>
            ...
            <nav ref={wrapperRef} className={classes.navbar}>
                ...
                >
                    ...
                    <svg style={{margin: window.innerWidth > 600 ? '0 50px': 'calc(auto + env(safe-area-inset-top)) 10px'}}  width={window.innerWidth > 600 ? "200" : "120"}  viewBox="0 0 200 56" fill="none" xmlns="http://www.w3.org/2000/svg">
