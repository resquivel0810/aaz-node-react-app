            ...
            <nav className='navbar navbar-dark navbar-expand-lg navbar-primary fixed-top'>
                <div style={{display: 'flex', alignItems: 'center'}}>
                    ...
                    <Link
                        ...
                        style={{paddingLeft: '0'}}
                    >
                        <svg style={{margin: window.innerWidth > 600 ? '0 50px': '0 15px'}}  width={window.innerWidth > 600 ? "200" : "0"} id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 73 22">
                            <g>
