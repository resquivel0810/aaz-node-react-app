...
export default function Intro({jwt}) {
    return (
        <>
                ...
                <div className='row py-4'>
                    ...
                    <div className='d-none d-lg-block col align-self-center fade-right'>
                        ...
                        <div className='py-4 body_text'>
                            ...
                            Nulla id quam sit amet lectus porttitor convallis ac non sem. Maecenas 
                            laoreet ante libero, non interdum felis semper sit amet. Nunc ultrices, 
                            dui euismod 
                        </div>
                        <div className='py-4'>
                            {
        ...
        <div className='bg_introHP_mobile d-md-block d-lg-none'>
            <div className='container position-relative'>
                ...
                <div className='py-4 body_text'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean arcu orci, 
                    commodo ut vestibulum et, imperdiet ac lorem. Suspendisse ac aliquam nisl. 
                    Nulla id quam sit amet lectus porttitor convallis ac non sem. Maecenas laoreet 
                    ante libero, non interdum felis semper sit amet. Nunc ultrices, dui euismod 
                </div>
